...
| CSS | [Tailwind CSS v4](https://tailwindcss.com/) + [@tailwindcss/forms](https://github.com/tailwindlabs/tailwindcss-forms) |
| UI コンポーネント | [Preline UI v4](https://preline.co/) |
...
バイナリ・SQLite ファイル・生成済み CSS・Preline JS を削除します。
...
```bash
# Linux / macOS
rm -f webapp user.sqlite3 public/assets/css/style.css public/assets/js/preline.js

# Windows (PowerShell)
Remove-Item -ErrorAction SilentlyContinue webapp.exe, user.sqlite3, public\assets\css\style.css, public\assets\js\preline.js
```
